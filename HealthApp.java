...
public class HealthApp
{
  ...
  public void addCustomer()
  {
    ...
    date = Validator.getLine(sc, "Enter Birthdate(ex: 2012-12-12 12:12:12): ");
  ...
  public void weeklyCompWeighIn()
  {
    ...
    double weightLossPercentage = (weightLoss/weight1 * 100);

    if (weightLoss > 0)
    {
      weightLossPercentage = ((weightLoss/weight1) * 100);
    ...
    System.out.println("You weighed " + weight1 + " on " + day1 + "\n" +
                       ...
                       "Your percentage of weight loss is: " + weightLossPercentage);
    }
    else
    {
  ...
  public void weeklyDiaryEntries()
  {
    ...
    String day6 = day5.substring(0,day5.length()-1) + (Integer.parseInt(day5.substring(day5.length()-1))+1); 
    String day7 = day6.substring(0,day6.length()-1) + (Integer.parseInt(day6.substring(day6.length()-1))+1); 
    String d1 =  mydb.diaryLog(day1);
    String d2 =  mydb.diaryLog(day2);
    String d3 =  mydb.diaryLog(day3);
    String d4 =  mydb.diaryLog(day4);
    String d5 =  mydb.diaryLog(day5);
    String d6 =  mydb.diaryLog(day6);
    String d7 =  mydb.diaryLog(day7);
